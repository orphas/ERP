...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/settings/users", label: "User Access", roles: ["admin"] as Role[], icon: "M17 20h5v-2a3 3 0 00-4.356-2.683M9 20H4v-2a3 3 0 015-2.829M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 10v-1a3 3 0 00-3-3h-1m-8 4v-1a3 3 0 013-3h1" },
    ],
  },
];
